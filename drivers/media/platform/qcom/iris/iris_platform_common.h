...
struct iris_platform_data {
	...
	u32 max_core_mbpf;
	u32 max_core_mbps;
	const u32 *input_config_params_dec;
	unsigned int input_config_params_dec_size;
	const u32 *output_config_params_dec;
	unsigned int output_config_params_dec_size;
	const u32 *input_config_params_enc;
	unsigned int input_config_params_enc_size;
	const u32 *output_config_params_enc;
	unsigned int output_config_params_enc_size;

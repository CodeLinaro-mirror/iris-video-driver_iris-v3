	...
	if (inst->domain == DECODER) {
		if (V4L2_TYPE_IS_OUTPUT(plane)) {
			if (inst->codec == V4L2_PIX_FMT_H264) {
				...
				config_params = core->iris_platform_data->dec_input_config_params_hevc;
				config_params_size =
					core->iris_platform_data->dec_input_config_params_hevc_size;
			} else if (inst->codec == V4L2_PIX_FMT_VP9) {
				config_params = core->iris_platform_data->dec_input_config_params_vp9;
				config_params_size =
			...
			config_params = core->iris_platform_data->dec_output_config_params;
			config_params_size = core->iris_platform_data->dec_output_config_params_size;
		}
	} else {
		if (V4L2_TYPE_IS_OUTPUT(plane)) {
			...
			config_params = core->iris_platform_data->enc_output_config_params;
			config_params_size = core->iris_platform_data->enc_output_config_params_size;
		}
	}
